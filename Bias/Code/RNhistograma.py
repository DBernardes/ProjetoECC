...
"""
    ...
    Descricao: esta biblioteca possui as seguintes funcoes:
		...
		geraDados: esta funcao gera um histograma dos dados fornecida uma imagem em formato numpy
		(imagem esta resultante da combinacao de uma amostra de imagens da serie de dados). Sobre
		esses dados e calculado a media, mediana, desvio padrao e desvio padrao absoluto. Alem disso,
		e gerado um segundo histograma normalizado em relacao a media e desvio padrao obtidos para servir
		de comparacao. Um intervalo de 7 sigmas e estipulado ao redor da mediana para o calculo do histograma
		e de suas informacoes.

		plothist: esta funcao e responsavel pelo plot do histograma dos dados e do shitograma normalizado;
		sobre ele sao expressao informacoes como valor medio e intervalo de valores dentro da media +/- sigma.
		Essas dados sao obtidos atraves de uma interpolacao cubica, retornando-os a um vetor para posterior exibicao.
