...
def CriaLogfile(Dic, DCnominal):
	...
	StrNomeImagens += '--------------------------------------------------------\n'
	directories = DCReadArq.returnListDirectories()
	for Dir  in directories:
		chdir = cwd + '/' + Dir
		os.chdir(chdir)
		listaImgBias = DCReadArq.returnListImages(tagBias)
		listaImgDark = DCReadArq.returnListImages(tagDark)
